...
import net.hero.genai.chat.ChatController;
import net.hero.genai.git.GitController;
...
public final class MainWorkspaceController {
    ...
    public void notifyWorkspaceSelected(final java.io.File directory) {
        SecurityService.getInstance().setActiveWorkspace(directory);
        WorkflowService.getInstance().loadWorkspaceCustomWorkflows(directory);
        if (gitPanelController != null) {
    ...
    public void updateGitWidget(final GitStatus status) {
